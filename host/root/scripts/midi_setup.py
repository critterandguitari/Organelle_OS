...
def save():
    ...
    f.write("oscsend localhost 4001 /midich i " + str(midiIn) + "\n")
    f.write("oscsend localhost 4001 /midiOutCh i " + str(midiOut) + "\n")
    f.write("oscsend localhost 4001 /midiInGate i " + str(midiInGate) + "\n")
    f.write("oscsend localhost 4001 /midiOutGate i " + str(midiOutGate) + "\n")
    f.write("aconnect -x \n")
